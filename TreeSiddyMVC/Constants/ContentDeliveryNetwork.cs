namespace TreeSiddyMVC.Constants
{
    public static class ContentDeliveryNetwork
    {
        ...
        {
            public const string Domain = "*.firebase.com";
            public const string Domain2 = "*.firebaseio.com";
            public const string FirebaseUrl = "//cdn.firebase.com/js/client/2.2.6/firebase.js";
        }

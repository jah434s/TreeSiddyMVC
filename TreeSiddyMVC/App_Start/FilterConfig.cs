namespace TreeSiddyMVC
{
    using System.Web.Mvc;
    using System.Web.Routing;
    using Boilerplate.Web.Mvc.Filters;
    using TreeSiddyMVC.Constants;
        ...
        private static void AddContentSecurityPolicyFilters(GlobalFilterCollection filters)
        {
            ...
            filters.Add(
                new CspConnectSrcAttribute()
                {
                    ...
                    CustomSources = "wss://s-dal5-nss-18.firebaseio.com/.ws auth.firebase.com",
            ...
            filters.Add(
                new CspScriptSrcAttribute()
                {
                    ...
                    CustomSources = string.Join(" ", ContentDeliveryNetwork.Google.Domain, ContentDeliveryNetwork.Microsoft.Domain, ContentDeliveryNetwork.Firebase.Domain, ContentDeliveryNetwork.Firebase.Domain2),
